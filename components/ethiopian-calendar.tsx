...
export function EthiopianCalendar({
  ...
  const et_date: any = EthDateTime.fromEuropeanDate(new Date());

  const [currentMonth, setCurrentMonth] = useState(et_date.month);
  const [currentYear, setCurrentYear] = useState(et_date.year);
